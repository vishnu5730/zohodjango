...
class payment_made(models.Model):
    ...
    total_opening_balance = models.CharField(max_length=100,blank=True,null=True)
    sum_amount_due = models.CharField(max_length=100,blank=True,null=True)
...
class Creditnote(models.Model):
    ...
    active = models.BooleanField(default=True)
    status=models.TextField(max_length=255,null=True,blank=True) #updation
    paid = models.FloatField(null=True,blank=True)
    balance = models.FloatField(null=True,blank=True)
...
class recur_comments(models.Model):
    commentid = models.AutoField(('COMMENTID'), primary_key=True)
    recom = models.ForeignKey(Recurring_invoice,on_delete=models.CASCADE,null=True,blank=True)
    user=models.ForeignKey(User,on_delete=models.CASCADE,null=True,default='') 
    comment = models.CharField(max_length=250,null=True)
class cust_comment(models.Model):
    commentid = models.AutoField(('COMMENTID'), primary_key=True)
